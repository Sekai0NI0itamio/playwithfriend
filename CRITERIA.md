...
- [ ] Feels alive: long-term memory file per friend (facts + diary survive relog), rich snapshot (time/weather/mobs/owner state/inventory), idle proactivity (night/mobs/hurt owner), personality with opinions + remember tool; bare "hello bob" routes, re-spawn says already-here
